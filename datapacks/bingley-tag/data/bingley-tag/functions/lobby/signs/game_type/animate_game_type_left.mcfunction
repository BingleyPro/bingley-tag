...
execute if score game_type settings matches ..0 run scoreboard players operation game_type settings = max_game_types consts
...
# Add new sign
function bingley-tag:lobby/signs/game_type/summon_tag_sign_left with storage bingley-tag:settings/current_game_type
